        ...
        <div class="iq_wrapper">
            ...
            <header class="iq_header_1">
                <div class="container">
                    <!--Logo Wrap Start-->
                    <div class="iq_logo">
                        <a href="#"><img width="160" src="images/logo.jpg" alt="Iqoniq Themes"></a>
                    </div>
                    <!--Logo Wrap Start-->
                    ...
                    <div class="iq_ui_element">
                        ...
                        <div class="iq_top_strip">
                            ...
                            <div class="iq_time_wrap pull-right"><i class="fa fa-clock-o"></i><script type="text/javascript">var today = new Date();
                            ...
                            <div class="col-md-4">
                                <div class="iq_search_courses">
                                    ...
                                    <form method="post" action="login.php">
                                        ...
                                        <!--Input Start-->
                                        <div class="iq-input">
                                            <input class="iq_link_1" type="submit" value="login">
                                        </div>
                                        <div class="iq-input">
                                            <input class="iq_link_1" type="submit" value="Cancel">
                                        </div>
                                        <!--Input End-->
                                    </form>
                                </div>
